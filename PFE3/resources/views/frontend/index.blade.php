...
<body>
    <header class="header_section">
        <nav>
                ...
                <div class="desktop_menu ">
                    <ul>
                        ...
                        <li><a class="" href="{{ route('agencelogin') }}">Espace Agence</a></li>
        ...
        <div class="search">
            ...
            <div class="dropdown1">
                <select name="adresse" class="a">
                    <option value="" selected disabled hidden>Adresse</option>
            ...
            <div class="dropdown2">
                <select name="agence">
                    ...
                    <option value="Azli">Mhamid</option>
                    <option value="Mhamid">Azli dwar l7rch num 1700 marrakech</option>
                </select>
            </div>
            <div class="dropdown3">
                <select name="brand">
        ...
        <div class="container cars_container">
            ...
            <div class="row row1">
                <div class="col  car_card">
                    <div class="car_img">
                        <img src="Assets/car exmaple.png" alt="">
                    </div>
                    <div class="car_info">
                        <div class="container">
                            <h4>AUDI A5</h4>
                            ...
                            <p class="price">Price/Day <br> 300 DH</p>
                            <div class="rent_now">
    ...
    <section class="espace_agence">
        <div class="container">
            ...
            <div class="text-center">
                <button class="register_now"> <a href="">Register now</a> </button>
            </div>
        </div>
    </section>
    <!-- Témoignages-->
...
<div class="container contact_us_rectangle  ">
    ...
    <form class="contact_form" method="post" action="sendEmail.php">
