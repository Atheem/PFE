...
<div class="container contact_us_rectangle  ">
    ...
    <form class="contact_form" method="post" action="{{ route('contact') }}">
        ...
        <div class="input-field col s12">
          <input id="name" type="text" name="mainName"  class="validate">
          <label for="name">Nom</label>
        </div>
      </div>
      <div class="form-group">
        <div class="input-field col s12">
          <input id="clientSubject" type="text" name="clientSubject"  class="validate">
          <label for="clientSubject">Sujet</label>
        </div>
      </div>
      <div class="form-group">
        <div class="input-field col s12">
          <input id="clientMail" type="email" name="clientMail"  class="validate">
