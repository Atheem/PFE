...
class VoitureController extends Controller
{
    ...
    {
        $reserv = DB::select('select num_contart,modele,immatriculation,date_depart,date_retour,cin,users.name as nom from users join reservations on reservations.id_client=users.id join voitures on voitures.id=reservations.id_voiture join agences on agences.id=voitures.location_id where agences.id in (select location_id from voitures  where  location_id=?)',[Auth::guard('agence')->user()->id]);
