...
Route::get('/TopCars','HomeController@topcars')->name('topcars');
Route::get('/Contact','HomeController@contact')->name('us');


//espaceagence
Route::view('/Espace-Agence','frontend.espaceagence')->name('espaceagence');
...
//CILENT
    ...
    Route::get('/Reçu/{id}', 'HomeController@pdf')->name('pdf');

//ADMIN

Route::get('/admin/Agence','AdminController@viewagence')->name('ags');
Route::get('/admin/Client','AdminController@viewclient')->name('cls');
Route::get('/admin/Message','AdminController@message')->name('message');
Route::get('/admin/Message/{id}', 'AdminController@ev');
Route::delete('/admin/agence/{id}','AdminController@destroya');
Route::delete('/admin/client/{id}','AdminController@destroyc');
